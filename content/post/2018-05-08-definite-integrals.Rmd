...
So pretty standard stuff. `ggplot::stat_function` 
...
In general it is not easy to find antiderivatives such as above, so we use [numerical integration schemes](https://en.wikipedia.org/wiki/Numerical_integration) in order to approximate solutions. 
